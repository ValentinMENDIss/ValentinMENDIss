# ValentinMENDIss
<img src="https://capsule-render.vercel.app/api?type=waving&color=auto&height=300&section=header&text=ValentinMENDIss&fontSize=90" />
...
### **Why do I do this?**
**Of course, because I love it :)**. **As a kid I always felt attached to electronic devices, computers and just everything related to programming**. I really loved to tinker with games, adding files to modify them and to improve overall performance (you may know such game, that have bugs or errors, but the developers don't fix, so if you want to have better overall experience you will need to try to solve it yourself, be it by changing libraries with newer ones, tweaking some minor isssues in readable and configurable files, etc :) ), and just seeing how the game works and what **can** be changed.
...
<img align="left" alt="CMake" width="30px" style="padding-right:10px;" src="https://github.com/devicons/devicon/blob/master/icons/cmake/cmake-original.svg">
